...
#The Credit For This Code Modify Goes To Akil 
...
\033[1;93m.      _   _  _____ _    

\033[1;91m     /_\ | |/ /_ _| |   

\033[1;93m   / _ \| ' < | || |__ 

\033[1;92m  /_/ \_\_|\_\___|____|

\033[1;91m--> INSTAGRAM  :- mdfuadhasanakil

\033[1;95m--> FACEBOOK   :- Md Fuad Hasan Akil

\033[1;91m--> YOUTUBE    :-  Max Official 

\033[1;91m--> TEAM       :- TAKE DOWN FIGHTERS
...
\033[1;92m--> TEAM NAME    :-  TAKE DOWN FIGHTERS
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://youtube.com/channel/UC2s3xWCwfWKyvdOc_SYbwrQ')
...
def login1():
	...
	try:
		...
		jalan('  \033[1;95mNote Do Not Use Your Personal Account' )
...
def pilih_crack():
	...
	print "  Written By Ijaz Akil" #Dev:Ijaz
